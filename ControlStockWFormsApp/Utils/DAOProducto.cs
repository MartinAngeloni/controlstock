...
namespace ControlStockWFormsApp.Utils
{
    static class DAOProducto
    {
        ...
        public static SqlDataAdapter sqaProducto = new SqlDataAdapter("Select I.codigo as Codigo, P.Nombre, M.nombre as Marca, P.Modelo, C.color, I.Precio, I.stock, I.alerta_stock, I.id, I.id_producto from Producto P inner join ProXm I on P.Cod_Producto = I.id_producto inner join Marca M on I.id_marca = M.id inner join Color C on I.id_color = C.id where I.baja = 0", Variables.conexion);
        ...
        public static SqlDataAdapter sqaProductoInAlert = new SqlDataAdapter("Select I.codigo as Codigo, P.Nombre, M.nombre as Marca, P.Modelo, C.color, I.Precio, I.stock, I.alerta_stock from Producto P inner join ProXm I on P.Cod_Producto = I.id_producto inner join Marca M on I.id_marca = M.id inner join Color C on I.id_color = C.id where I.alerta_stock > I.stock and I.baja = 0", Variables.conexion);
